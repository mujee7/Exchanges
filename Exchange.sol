...
emit Cancel(_order.id,msg.sender,_order.tokenGet,_order.tokenGive,_order.amountGet,_order.amountGive,now);
...
function _trade(uint256 _id,address _user,address _tokenGet,address _tokenGive,uint256 _amountGet,uint256 _amountGive)internal {
...
emit Trade( _id,_user,_tokenGet, _tokenGive,_amountGet,_amountGive,msg.sender,now);
}
